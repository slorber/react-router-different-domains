...
import { Router,useRouterHistory, Route, IndexRoute, Link, IndexLink, browserHistory } from 'react-router'


import { createHistory, useBasename } from 'history'
const history = useRouterHistory(createHistory)({
  // Uncomment this if you want link clicking on port 9000 to work
